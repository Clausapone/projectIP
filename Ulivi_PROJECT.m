...
LDA_Model = fitcdiscr(X_Train, Y_Train, 'DiscrimType', 'linear', 'OptimizeHyperparameters','auto');
...
LDA_Model = fitcdiscr(X_Train, Y_Train, 'DiscrimType', 'diaglinear', 'OptimizeHyperparameters','auto');
Y_Pred_LDA = predict(LDA_Model, X_Test);
...
LDA_Model = fitcdiscr(X_Train, Y_Train, 'DiscrimType', 'pseudolinear', 'OptimizeHyperparameters','auto');
Y_Pred_LDA = predict(LDA_Model, X_Test);
